...
export const TIER_TABLE = [
  { id: 1 as TierId, min: 0,       max: 19_999,   apy: 14.2 },
  { id: 2 as TierId, min: 20_000,  max: 49_999,   apy: 19.8 },
  { id: 3 as TierId, min: 50_000,  max: 99_999,   apy: 26.4 },
  { id: 4 as TierId, min: 100_000, max: Infinity, apy: 32.5 },
];
...
export function tierForTotal(total: number) {
  ...
  return { tier: 1 as TierId, apy: 14.2 };
}
