...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      'All transactions are verified on-chain, ensuring safety and immutability.',
  ...
  },
  {
    ...
    answer: [
      ...
      'Each tier offers a higher Annual Percentage Yield (APY), starting at 48.7% and going up to 56.8% for higher commitments.',
  ...
  },
  {
    ...
    answer: [
      ...
      'Withdrawals in TON may include a small network fee of up to 1%, depending on the amount.',
      'All transactions are processed automatically and securely within minutes.',
      'The system ensures a smooth experience with full on-chain traceability.'
    ].join('\n'),
  },
  {
  ...
  },
  {
    ...
    answer: [
      ...
      'A portion of all staking activity contributes to Telegram’s payment and staking infrastructure development.',
      'This ensures faster payments, higher scalability, and a sustainable economic loop.',
  ...
  },
  {
    ...
    answer: [
      'APY (Annual Percentage Yield) represents your yearly return, but rewards are calculated and added daily based on your staked amount.',
      'For example, a 48.7% APY roughly equals around 4% monthly growth, meaning if you stake 1,000 Stars, you’ll see around 1,040 Stars after one month.',
      'Your balance increases gradually every day, compounding works automatically, so each day’s yield builds upon the last.',
      'This ensures consistent and transparent growth without needing manual actions.',
      'In short, the longer you stake, the more your returns accumulate exponentially over time.'
    ].join('\n'),
  },
  {
    question: 'Is there any risk of losing my Stars?',
    answer: [
      'No, Stars Stake operates under a non-custodial structure, meaning you always retain ownership of your assets.',
      'Your funds remain securely locked and verifiable at all times.',
      'The system’s smart contract architecture ensures complete transparency and on-chain security.',
      'The only variable is yield fluctuation, not the safety of your funds.'
    ].join('\n'),
  },
  {
    ...
    answer: [
      ...
      'While the base APY starts at 48.7%, it can increase as you move through higher staking tiers.',
      ...
      'The system ensures that returns remain stable and competitive under all market conditions.'
    ].join('\n'),
  },
  {
    question: 'What is the minimum and maximum amount I can stake?',
    answer: [
      'The minimum amount to participate in staking is 100 Stars, ensuring accessibility for all users.',
      'There’s no maximum limit, you can continue staking without restrictions.',
      'However, higher amounts automatically unlock higher tiers and better APY rates.',
  ...
  },
   {
    ...
    answer: [
      'Stars Stake is the first ecosystem-native staking model built around Telegram Stars.',
      'It combines high APY rewards with real utility, supporting marketplace liquidity and infrastructure.',
      'Unlike speculative staking apps, all value flows remain within the Telegram ecosystem.',
  ...
  },
  {
    ...
    answer: [
      'Yes, all rewards are distributed automatically and updated daily within your account balance.',
  ...
  },
  {
    ...
    answer: [
      'APY rates are recalculated continuously based on your active tier and the system’s liquidity health.',
  ...
  },
  {
    ...
    answer: [
      ...
      'After the lock ends, you’re completely free to withdraw or restake without limits.'
    ].join('\n'),
  },
  {
    ...
    answer: [
      ...
      'All adjustments are algorithmic and fully transparent to maintain fairness.'
    ].join('\n'),
  },
  {
    question: 'How does compounding work in Stars Stake?',
    answer: [
      'Compounding means your daily rewards are added to your staked balance automatically.',
      'Each new day, your yield is calculated on the updated balance, not just the original deposit.',
      'This creates an exponential growth effect over time, boosting long-term returns.',
    ].join('\n'),
  },
  {
    question: 'Can system updates affect my staking balance?',
    answer: [
      'No, updates or maintenance operations never affect your staked amount or accumulated rewards.',
      'All staking data is stored securely and synchronized on Telegram’s verified systems.',
      'In rare cases, temporary display delays may occur, but your funds always remain safe.',
