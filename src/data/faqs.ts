...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      'Each tier offers a higher Annual Percentage Yield (APY), starting at 58.6% and going up to 83.7% for higher commitments.',
  ...
  },
  {
    ...
    answer: [
      ...
      'For example, a 58.6% APY corresponds to roughly ~3.92% per month (compounded). If you stake 1,000 Stars, you’ll see about 1,039 after one month (before rounding on display).',
